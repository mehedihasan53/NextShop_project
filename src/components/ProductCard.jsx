                ...
                <div className="relative z-10">
                    ...
                    <div className="relative h-48 lg:h-56 overflow-hidden bg-slate-700/50">
                        ...
                        <div className="absolute top-4 right-4">
                            <div className="
                                px-3 py-1.5 bg-slate-900/80 backdrop-blur-sm border border-slate-700/50 
                                rounded-full text-sm font-semibold text-cyan-300
                                group-hover:bg-cyan-500/20 group-hover:border-cyan-500/30 group-hover:text-cyan-200
                    ...
                    <div className="p-6">
                        {/* Product Name */}
                        <h3 className="
                            text-lg lg:text-xl font-semibold text-white mb-2 
                        ...
                        {/* Product Description */}
                        <p className="
                            text-slate-400 text-sm lg:text-base leading-relaxed mb-4
